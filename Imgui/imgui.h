...
namespace ImGui
{
	...
	IMGUI_API void			GetMatrixInfomation(const char* name, D3DXMATRIX MtxTarget);				//各行列の情報を取得させ、情報を表示する。	
	IMGUI_API void			GetPositionInfomation(const char* name, D3DXVECTOR3 TargetPosition);		//対象の位置情報を表示する。
	IMGUI_API void			GetRotationInfomation(const char* name, D3DXVECTOR3 TargetRotation);		//対象の回転情報を表示する。
